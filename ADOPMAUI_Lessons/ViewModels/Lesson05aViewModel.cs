...
{
    public class Lesson05ViewModel
    {
        public Lesson05ViewModel(Type type, string title, string description)
        {
            Type = type;
            Title = title;
        ...
        static Lesson05ViewModel()
        {
            All = new List<Lesson05ViewModel>
            {
                new Lesson05ViewModel(typeof(ContentPage1), "ContentPage1",
                        "Navigate to ContentPage1"),

                new Lesson05ViewModel(typeof(ContentPage2), "ContentPage2",
                        "Navigate to ContentPage2"),
                
                new Lesson05ViewModel(typeof(ContentPage3), "ContentPage3",
        ...
        public static IList<Lesson05ViewModel> All { private set; get; }
    }
}
